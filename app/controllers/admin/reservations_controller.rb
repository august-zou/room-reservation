class Admin::ReservationsController < ApplicationController
  def index
    @reservation_records =ReservationRecord.all.paginate(:page => params[:page])
  end
  ...
  def reservation_params
    permited = params.required(:reservation_record).permit(:room_id, :start_datetime, 
      :stop_datetime, :usage, :remarks)  
